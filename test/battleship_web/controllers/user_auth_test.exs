defmodule BattleshipWeb.UserAuthTest do
  use BattleshipWeb.ConnCase, async: true

  alias Battleship.Accounts
  alias BattleshipWeb.UserAuth
  import Battleship.AccountsFixtures

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, BattleshipWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      BattleshipWeb.Endpoint.subscribe(live_socket_id)
