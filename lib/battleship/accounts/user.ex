defmodule Battleship.Accounts.User do
  use Ecto.Schema
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, Battleship.Repo)
  ...
  """
  def valid_password?(%Battleship.Accounts.User{hashed_password: hashed_password}, password)
